...
public class MeetingRoomController {
    ...
    public R insert(@Valid @RequestBody UpdateMeetingRoomForm form){
        TbMeetingRoom meetingRoom = JSONUtil.parse(form).toBean(TbMeetingRoom.class);
    ...
    public R deleteMeetingRoom(@Valid @RequestBody DeleteMeetingRoomByIdsForm form){
        int rows = meetingRoomService.deleteMeetingRoom(form.getIds());
        return R.ok().put("rows",rows);
    }
}